...
INSERT INTO historialpersona (idpersona,ideps,tipoafiliado,fechaingreso,fecharetiro,estadopersona,idTipoServicio) VALUES (17360310,	7, 1,STR_TO_DATE('01/10/2008','%d/%m/%Y'),STR_TO_DATE('30/09/2010','%d/%m/%Y'),'I','1');
